...
#ifndef _PAL_D3D12_DESCRIPTOR_ALLOCATOR_H_
#define _PAL_D3D12_DESCRIPTOR_ALLOCATOR_H_ 1

#include "pal_map.h"

class pal_d3d12_descriptor_allocator
{
	...
	pal_map<uint32_t, uint32_t> m_cbv_srv_uav_descriptor_heap_free_list;
