...
pal_vk_descriptor_set_layout::pal_vk_descriptor_set_layout()
...
void pal_vk_descriptor_set_layout::init(uint32_t descriptor_set_binding_count, PAL_DESCRIPTOR_SET_LAYOUT_BINDING const *wrapped_descriptor_set_bindings, PFN_vkGetDeviceProcAddr pfn_get_device_proc_addr, VkDevice device, VkAllocationCallbacks const *allocation_callbacks)
{
    ...
    pal_vector<VkDescriptorSetLayoutBinding> descriptor_set_bindings(static_cast<size_t>(descriptor_set_binding_count));
...
void pal_vk_descriptor_set_layout::uninit(PFN_vkGetDeviceProcAddr pfn_get_device_proc_addr, VkDevice device, VkAllocationCallbacks const *allocation_callbacks)
{
...
VkDescriptorSetLayout pal_vk_descriptor_set_layout::get_descriptor_set_layout() const
{
    return this->m_descriptor_set_layout;
}

uint32_t pal_vk_descriptor_set_layout::get_dynamic_uniform_buffer_descriptor_count() const
{
    return this->m_dynamic_uniform_buffer_descriptor_count;
}

uint32_t pal_vk_descriptor_set_layout::get_sampled_image_descriptor_count() const
{
    return this->m_sampled_image_descriptor_count;
}

uint32_t pal_vk_descriptor_set_layout::get_sampler_descriptor_count() const
{
    return this->m_sampler_descriptor_count;
}

uint32_t pal_vk_descriptor_set_layout::get_storage_image_descriptor_count() const
{
    return this->m_storage_image_descriptor_count;
}

uint32_t pal_vk_descriptor_set_layout::get_top_level_acceleration_structure_descriptor_count() const
{
    return this->m_top_level_acceleration_structure_descriptor_count;
}

pal_vk_pipeline_layout::pal_vk_pipeline_layout(VkPipelineLayout pipeline_layout) : m_pipeline_layout(pipeline_layout)
{
}

VkPipelineLayout pal_vk_pipeline_layout::get_pipeline_layout() const
{
    return this->m_pipeline_layout;
}

void pal_vk_pipeline_layout::steal(VkPipelineLayout *out_pipeline_layout)
{
...
pal_vk_pipeline_layout::~pal_vk_pipeline_layout()
{
    assert(VK_NULL_HANDLE == this->m_pipeline_layout);
}

pal_vk_descriptor_set::pal_vk_descriptor_set() : m_descriptor_pool(VK_NULL_HANDLE), m_descriptor_set(VK_NULL_HANDLE)
{
}

void pal_vk_descriptor_set::init(pal_descriptor_set_layout const *wrapped_descriptor_set_layout, PFN_vkGetDeviceProcAddr pfn_get_device_proc_addr, VkDevice device, VkAllocationCallbacks const *allocation_callbacks)
{
    ...
    pal_vk_descriptor_set_layout const *unwrapped_descriptor_set_layout = static_cast<pal_vk_descriptor_set_layout const *>(wrapped_descriptor_set_layout);
    ...
    pal_vector<VkDescriptorPoolSize> descriptor_pool_sizes;
...
void pal_vk_descriptor_set::uninit(PFN_vkGetDeviceProcAddr pfn_get_device_proc_addr, VkDevice device, VkAllocationCallbacks const *allocation_callbacks)
{
    assert(VK_NULL_HANDLE != this->m_descriptor_set);
...
void pal_vk_descriptor_set::write_descriptor(PFN_vkGetDeviceProcAddr pfn_get_device_proc_addr, VkDevice device, PAL_DESCRIPTOR_TYPE wrapped_descriptor_type, uint32_t dst_binding, uint32_t dst_array_element, uint32_t src_descriptor_count, pal_upload_ring_buffer const *const *src_dynamic_uniform_buffers, uint32_t const *src_dynamic_uniform_buffers_range, pal_sampled_image const *const *src_sampled_images, pal_sampler const *const *src_samplers, pal_storage_image const *const *src_storage_images, pal_top_level_acceleration_structure const *const *src_top_level_acceleration_structures)
{
    ...
    pal_vector<VkDescriptorBufferInfo> buffer_info(static_cast<size_t>(src_descriptor_count));
    pal_vector<VkDescriptorImageInfo> image_info(static_cast<size_t>(src_descriptor_count));
    pal_vector<VkAccelerationStructureKHR> acceleration_structure_info(static_cast<size_t>(src_descriptor_count));
    ...
    case PAL_DESCRIPTOR_TYPE_DYNAMIC_UNIFORM_BUFFER:
    {
        ...
        for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
        {
            ...
            buffer_info[descriptor_index].buffer = static_cast<pal_vk_upload_ring_buffer const *>(src_dynamic_uniform_buffers[descriptor_index])->get_buffer();
            buffer_info[descriptor_index].offset = 0U;
            buffer_info[descriptor_index].range = src_dynamic_uniform_buffers_range[descriptor_index];
        }
    }
    break;
    case PAL_DESCRIPTOR_TYPE_SAMPLED_IMAGE:
    {
        ...
        for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
        {
            ...
            image_info[descriptor_index].imageView = static_cast<pal_vk_sampled_image const *>(src_sampled_images[descriptor_index])->get_image_view();
    ...
    case PAL_DESCRIPTOR_TYPE_SAMPLER:
    {
        ...
        for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
        {
            ...
            image_info[descriptor_index].sampler = static_cast<pal_vk_sampler const *>(src_samplers[descriptor_index])->get_sampler();
    ...
    case PAL_DESCRIPTOR_TYPE_STORAGE_IMAGE:
    {
        ...
        for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
        {
            ...
            image_info[descriptor_index].sampler = VK_NULL_HANDLE;
            image_info[descriptor_index].imageView = static_cast<pal_vk_storage_image const *>(src_storage_images[descriptor_index])->get_image_view();
    ...
    case PAL_DESCRIPTOR_TYPE_TOP_LEVEL_ACCELERATION_STRUCTURE:
    {
        ...
        for (uint32_t descriptor_index = 0U; descriptor_index < src_descriptor_count; ++descriptor_index)
        {
            ...
            acceleration_structure_info[descriptor_index] = static_cast<pal_vk_top_level_acceleration_structure const *>(src_top_level_acceleration_structures[descriptor_index])->get_acceleration_structure();
        }
    }
    break;
    default:
...
VkDescriptorSet pal_vk_descriptor_set::get_descriptor_set() const
{
