...
pal_d3d12_graphics_command_buffer::pal_d3d12_graphics_command_buffer()
...
void pal_d3d12_graphics_command_buffer::init(ID3D12Device *device, bool uma, bool support_ray_tracing, pal_d3d12_descriptor_allocator *descriptor_allocator)
{
...
void pal_d3d12_graphics_command_buffer::uninit()
{
    assert(NULL != this->m_command_list);
...
ID3D12CommandAllocator *pal_d3d12_graphics_command_buffer::get_command_allocator() const
{
    return this->m_command_allocator;
}

ID3D12GraphicsCommandList4 *pal_d3d12_graphics_command_buffer::get_command_list() const
{
    return this->m_command_list;
}

void pal_d3d12_graphics_command_buffer::begin()
{
...
void pal_d3d12_graphics_command_buffer::acquire_asset_vertex_position_buffer(pal_asset_vertex_position_buffer *wrapped_asset_vertex_position_buffer)
{
    ...
    ID3D12Resource *const asset_buffer_resource = static_cast<pal_d3d12_asset_vertex_position_buffer *>(wrapped_asset_vertex_position_buffer)->get_resource();
...
void pal_d3d12_graphics_command_buffer::acquire_asset_vertex_varying_buffer(pal_asset_vertex_varying_buffer *wrapped_asset_vertex_varying_buffer)
{
    // The D3D12_RESOURCE_STATE_VERTEX_AND_CONSTANT_BUFFER is invalid for compute queue and we have to insert this barreir on graphics queue

    assert(NULL != wrapped_asset_vertex_varying_buffer);
    ID3D12Resource *const asset_buffer_resource = static_cast<pal_d3d12_asset_vertex_varying_buffer *>(wrapped_asset_vertex_varying_buffer)->get_resource();
...
void pal_d3d12_graphics_command_buffer::acquire_asset_index_buffer(pal_asset_index_buffer *wrapped_asset_index_buffer)
{
    ...
    ID3D12Resource *const asset_buffer_resource = static_cast<pal_d3d12_asset_index_buffer *>(wrapped_asset_index_buffer)->get_resource();
...
void pal_d3d12_graphics_command_buffer::acquire_asset_sampled_image(pal_asset_sampled_image *wrapped_asset_sampled_image, uint32_t dst_mip_level)
{
    ...
    ID3D12Resource *asset_sampled_image_resource = static_cast<pal_d3d12_asset_sampled_image *>(wrapped_asset_sampled_image)->get_resource();
...
void pal_d3d12_graphics_command_buffer::acquire_asset_compacted_bottom_level_acceleration_structure(pal_asset_compacted_bottom_level_acceleration_structure *wrapped_asset_compacted_bottom_level_acceleration_structure)
{
    ID3D12Resource *asset_buffer_resource = static_cast<pal_d3d12_asset_compacted_bottom_level_acceleration_structure *>(wrapped_asset_compacted_bottom_level_acceleration_structure)->get_resource();
...
void pal_d3d12_graphics_command_buffer::begin_debug_utils_label(char const *label_name)
{
#ifndef NDEBUG
...
void pal_d3d12_graphics_command_buffer::end_debug_utils_label()
{
#ifndef NDEBUG
...
void pal_d3d12_graphics_command_buffer::begin_render_pass(pal_render_pass const *pal_render_pass, pal_frame_buffer const *pal_frame_buffer, uint32_t width, uint32_t height, uint32_t color_clear_value_count, float const (*color_clear_values)[4], float const *depth_clear_value, uint8_t const *stencil_clear_value)
{
    assert(NULL != pal_render_pass);
    assert(NULL != pal_frame_buffer);
    assert(NULL == this->m_current_render_pass);
    assert(NULL == this->m_current_frame_buffer);
    this->m_current_render_pass = static_cast<pal_d3d12_render_pass const *>(pal_render_pass);
    this->m_current_frame_buffer = static_cast<pal_d3d12_frame_buffer const *>(pal_frame_buffer);
...
void pal_d3d12_graphics_command_buffer::bind_graphics_pipeline(pal_graphics_pipeline const *wrapped_graphics_pipeline)
{
    assert(NULL != wrapped_graphics_pipeline);
    pal_d3d12_graphics_pipeline const *const unwrapped_graphics_pipeline = static_cast<pal_d3d12_graphics_pipeline const *>(wrapped_graphics_pipeline);
...
void pal_d3d12_graphics_command_buffer::set_view_port(uint32_t width, uint32_t height)
{
...
void pal_d3d12_graphics_command_buffer::set_scissor(uint32_t width, uint32_t height)
{
    D3D12_RECT rect = {0, 0, static_cast<LONG>(width), static_cast<LONG>(height)};
    this->m_command_list->RSSetScissorRects(1U, &rect);
}

void pal_d3d12_graphics_command_buffer::bind_graphics_descriptor_sets(pal_pipeline_layout const *wrapped_pipeline_layout, uint32_t descriptor_set_count, pal_descriptor_set const *const *wrapped_descriptor_sets, uint32_t dynamic_offet_count, uint32_t const *dynamic_offsets)
{
    assert(NULL != wrapped_pipeline_layout);
    assert(NULL != wrapped_descriptor_sets);
    ID3D12RootSignature *root_signature = static_cast<pal_d3d12_pipeline_layout const *>(wrapped_pipeline_layout)->get_root_signature();
    ...
    for (uint32_t set_index = 0U; set_index < descriptor_set_count; ++set_index)
    {
        ...
        uint32_t const binding_count = static_cast<pal_d3d12_descriptor_set const *>(wrapped_descriptor_sets[set_index])->get_descriptor_count();
        pal_d3d12_descriptor const *descriptors = static_cast<pal_d3d12_descriptor_set const *>(wrapped_descriptor_sets[set_index])->get_descriptors();
        for (uint32_t binding_index = 0U; binding_index < binding_count; ++binding_index)
        {
            ...
            {
            case PAL_DESCRIPTOR_TYPE_DYNAMIC_UNIFORM_BUFFER:
            {
            ...
            break;
            case PAL_DESCRIPTOR_TYPE_TOP_LEVEL_ACCELERATION_STRUCTURE:
            {
                D3D12_GPU_DESCRIPTOR_HANDLE base_descriptor = this->m_descriptor_allocator->get_cbv_srv_uav_gpu_descriptor_handle(descriptors[binding_index].root_descriptor_table.base_descriptor_heap_index);
                this->m_command_list->SetGraphicsRootDescriptorTable(root_parameter_index, base_descriptor);
                ++root_parameter_index;
...
void pal_d3d12_graphics_command_buffer::bind_vertex_buffers(uint32_t vertex_buffer_count, pal_vertex_buffer const *const *vertex_buffers)
{
    assert(this->m_current_vertex_buffer_strides.size() == vertex_buffer_count);

    pal_vector<D3D12_VERTEX_BUFFER_VIEW> vertex_buffer_views;
    {
        vertex_buffer_views.resize(vertex_buffer_count);
        for (uint32_t vertex_buffer_index = 0U; vertex_buffer_index < vertex_buffer_count; ++vertex_buffer_index)
        {
            assert(NULL != vertex_buffers[vertex_buffer_index]);
            ID3D12Resource *const resource = static_cast<pal_d3d12_vertex_buffer const *>(vertex_buffers[vertex_buffer_index])->get_resource();
...
void pal_d3d12_graphics_command_buffer::draw(uint32_t vertex_count, uint32_t instance_count)
{
    this->m_command_list->DrawInstanced(vertex_count, instance_count, 0U, 0U);
}

void pal_d3d12_graphics_command_buffer::draw_index(pal_asset_index_buffer const *wrapped_index_buffer, PAL_GRAPHICS_PIPELINE_INDEX_TYPE wrapped_index_type, uint32_t index_count, uint32_t instance_count)
{
    assert(NULL != wrapped_index_buffer);
    ID3D12Resource *const resource = static_cast<pal_d3d12_asset_index_buffer const *>(wrapped_index_buffer)->get_resource();
    D3D12_RESOURCE_DESC const resource_desc = resource->GetDesc();
...
void pal_d3d12_graphics_command_buffer::end_render_pass()
{
    assert(NULL != this->m_current_render_pass);
    assert(NULL != this->m_current_frame_buffer);
...
void pal_d3d12_graphics_command_buffer::compute_pass_load_storage_image(pal_storage_image const *wrapped_storage_image, PAL_STORAGE_IMAGE_LOAD_OPERATION load_operation)
{
    ID3D12Resource *const load_resource = static_cast<pal_d3d12_storage_image const *>(wrapped_storage_image)->get_resource();
...
void pal_d3d12_graphics_command_buffer::bind_compute_pipeline(pal_compute_pipeline const *wrapped_compute_pipeline)
{
    assert(NULL != wrapped_compute_pipeline);
    pal_d3d12_compute_pipeline const *const unwrapped_compute_pipeline = static_cast<pal_d3d12_compute_pipeline const *>(wrapped_compute_pipeline);
...
void pal_d3d12_graphics_command_buffer::bind_compute_descriptor_sets(pal_pipeline_layout const *wrapped_pipeline_layout, uint32_t descriptor_set_count, pal_descriptor_set const *const *wrapped_descriptor_sets, uint32_t dynamic_offet_count, uint32_t const *dynamic_offsets)
{
    assert(NULL != wrapped_pipeline_layout);
    assert(NULL != wrapped_descriptor_sets);
    ID3D12RootSignature *root_signature = static_cast<pal_d3d12_pipeline_layout const *>(wrapped_pipeline_layout)->get_root_signature();
...
void pal_d3d12_graphics_command_buffer::dispatch(uint32_t group_count_x, uint32_t group_count_y, uint32_t group_count_z)
{
    this->m_command_list->Dispatch(group_count_x, group_count_y, group_count_z);
}

void pal_d3d12_graphics_command_buffer::compute_pass_store_storage_image(pal_storage_image const *wrapped_storage_image, PAL_STORAGE_IMAGE_STORE_OPERATION store_operation)
{
    ID3D12Resource *const store_resource = static_cast<pal_d3d12_storage_image const *>(wrapped_storage_image)->get_resource();
...
void pal_d3d12_graphics_command_buffer::build_top_level_acceleration_structure(pal_scratch_buffer *wrapped_scratch_buffer, uint32_t scratch_buffer_offset, uint32_t top_level_acceleration_structure_instance_count, pal_top_level_acceleration_structure_instance_buffer *wrapped_top_level_acceleration_structure_instance_buffer, uint32_t top_level_acceleration_structure_start_instance_index, pal_top_level_acceleration_structure *wrapped_top_level_acceleration_structure)
{
    assert(NULL != wrapped_top_level_acceleration_structure);
    ID3D12Resource *const destination_acceleration_structure_buffer_resource = static_cast<pal_d3d12_top_level_acceleration_structure *>(wrapped_top_level_acceleration_structure)->get_resource();
    ...
    D3D12_GPU_VIRTUAL_ADDRESS const top_level_acceleration_structure_instance_buffer_device_memory_range_base = static_cast<pal_d3d12_top_level_acceleration_structure_instance_buffer *>(wrapped_top_level_acceleration_structure_instance_buffer)->get_resource()->GetGPUVirtualAddress();

    assert(NULL != wrapped_scratch_buffer);
    D3D12_GPU_VIRTUAL_ADDRESS const scratch_buffer_device_memory_range_base = static_cast<pal_d3d12_scratch_buffer *>(wrapped_scratch_buffer)->get_resource()->GetGPUVirtualAddress();

    static_assert(0U == (sizeof(D3D12_RAYTRACING_INSTANCE_DESC) % D3D12_RAYTRACING_INSTANCE_DESCS_BYTE_ALIGNMENT), "");
    assert(0U == ((top_level_acceleration_structure_instance_buffer_device_memory_range_base + sizeof(D3D12_RAYTRACING_INSTANCE_DESC) * top_level_acceleration_structure_start_instance_index) % D3D12_RAYTRACING_INSTANCE_DESCS_BYTE_ALIGNMENT));
    ...
    D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC const ray_tracing_acceleration_structure_desc = {
        ...
        {D3D12_RAYTRACING_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL,
         ...
         {.InstanceDescs = top_level_acceleration_structure_instance_buffer_device_memory_range_base + sizeof(D3D12_RAYTRACING_INSTANCE_DESC) * top_level_acceleration_structure_start_instance_index}},
        0U,
        scratch_buffer_device_memory_range_base + scratch_buffer_offset};
...
void pal_d3d12_graphics_command_buffer::update_top_level_acceleration_structure(pal_scratch_buffer *wrapped_scratch_buffer, uint32_t scratch_buffer_offset, uint32_t top_level_acceleration_structure_instance_count, pal_top_level_acceleration_structure_instance_buffer *wrapped_top_level_acceleration_structure_instance_buffer, uint32_t top_level_acceleration_structure_start_instance_index, pal_top_level_acceleration_structure *wrapped_top_level_acceleration_structure)
{
    assert(NULL != wrapped_top_level_acceleration_structure);
    ID3D12Resource *const destination_acceleration_structure_buffer_resource = static_cast<pal_d3d12_top_level_acceleration_structure *>(wrapped_top_level_acceleration_structure)->get_resource();
    D3D12_GPU_VIRTUAL_ADDRESS const destination_acceleration_structure_device_memory_range_base = destination_acceleration_structure_buffer_resource->GetGPUVirtualAddress();
...
void pal_d3d12_graphics_command_buffer::end()
{
    HRESULT const hr_close = this->m_command_list->Close();
    assert(SUCCEEDED(hr_close));
}

pal_d3d12_upload_command_buffer::pal_d3d12_upload_command_buffer() : m_command_allocator(NULL), m_command_list(NULL), m_upload_queue_submit_fence(NULL)
{
}

void pal_d3d12_upload_command_buffer::init(ID3D12Device *device, bool uma, bool support_ray_tracing)
{
    this->m_uma = uma;
...
void pal_d3d12_upload_command_buffer::uninit()
{
    if ((!this->m_uma) || this->m_support_ray_tracing)
    {
        assert(NULL != this->m_upload_queue_submit_fence);
...
pal_d3d12_upload_command_buffer::~pal_d3d12_upload_command_buffer()
{
    assert(NULL == this->m_command_allocator);
    assert(NULL == this->m_command_list);
    assert(NULL == this->m_upload_queue_submit_fence);
...
ID3D12CommandAllocator *pal_d3d12_upload_command_buffer::get_command_allocator() const
{
    return this->m_command_allocator;
}

ID3D12GraphicsCommandList4 *pal_d3d12_upload_command_buffer::get_command_list() const
{
    return this->m_command_list;
}

ID3D12Fence *pal_d3d12_upload_command_buffer::get_upload_queue_submit_fence() const
{
    return this->m_upload_queue_submit_fence;
}

void pal_d3d12_upload_command_buffer::begin()
{
    if ((!this->m_uma) || this->m_support_ray_tracing)
    {
        HRESULT hr_reset = this->m_command_list->Reset(this->m_command_allocator, NULL);
...
void pal_d3d12_upload_command_buffer::upload_from_staging_buffer_to_asset_vertex_position_buffer(pal_asset_vertex_position_buffer *wrapped_asset_vertex_position_buffer, uint64_t dst_offset, pal_staging_buffer *wrapped_staging_buffer, uint64_t src_offset, uint32_t src_size)
{
    ID3D12Resource *asset_buffer_resource = static_cast<pal_d3d12_asset_vertex_position_buffer *>(wrapped_asset_vertex_position_buffer)->get_resource();
    ID3D12Resource *staging_buffer_resource = static_cast<pal_d3d12_staging_buffer *>(wrapped_staging_buffer)->get_resource();

    if (!this->m_uma)
    {
        this->m_command_list->CopyBufferRegion(asset_buffer_resource, dst_offset, staging_buffer_resource, src_offset, src_size);
    ...
    else
    {
        ...
        void *staging_buffer_memory_range_base = static_cast<pal_d3d12_staging_buffer *>(wrapped_staging_buffer)->get_memory_range_base();

        std::memcpy(reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(asset_buffer_memory_range_base) + dst_offset), reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(staging_buffer_memory_range_base) + src_offset), src_size);
...
void pal_d3d12_upload_command_buffer::upload_from_staging_buffer_to_asset_vertex_varying_buffer(pal_asset_vertex_varying_buffer *wrapped_asset_vertex_varying_buffer, uint64_t dst_offset, pal_staging_buffer *wrapped_staging_buffer, uint64_t src_offset, uint32_t src_size)
{
    ID3D12Resource *asset_buffer_resource = static_cast<pal_d3d12_asset_vertex_varying_buffer *>(wrapped_asset_vertex_varying_buffer)->get_resource();
    ID3D12Resource *staging_buffer_resource = static_cast<pal_d3d12_staging_buffer *>(wrapped_staging_buffer)->get_resource();
...
void pal_d3d12_upload_command_buffer::upload_from_staging_buffer_to_asset_index_buffer(pal_asset_index_buffer *wrapped_asset_index_buffer, uint64_t dst_offset, pal_staging_buffer *wrapped_staging_buffer, uint64_t src_offset, uint32_t src_size)
{
    ID3D12Resource *asset_buffer_resource = static_cast<pal_d3d12_asset_index_buffer *>(wrapped_asset_index_buffer)->get_resource();
    ID3D12Resource *staging_buffer_resource = static_cast<pal_d3d12_staging_buffer *>(wrapped_staging_buffer)->get_resource();
...
void pal_d3d12_upload_command_buffer::upload_from_staging_buffer_to_asset_sampled_image(pal_asset_sampled_image *wrapped_asset_sampled_image, PAL_ASSET_IMAGE_FORMAT wrapped_asset_sampled_image_format, uint32_t asset_sampled_image_width, uint32_t asset_sampled_image_height, uint32_t dst_mip_level, pal_staging_buffer *wrapped_staging_buffer, uint64_t src_offset, uint32_t src_row_pitch, uint32_t src_row_count)
{
    assert(NULL != wrapped_asset_sampled_image);
    ID3D12Resource *const asset_sampled_image = static_cast<pal_d3d12_asset_sampled_image *>(wrapped_asset_sampled_image)->get_resource();

    assert(NULL != wrapped_staging_buffer);
    ID3D12Resource *const staging_buffer = static_cast<pal_d3d12_staging_buffer *>(wrapped_staging_buffer)->get_resource();
    ...
    uint32_t const block_width = pal_get_format_block_width(wrapped_asset_sampled_image_format);
    uint32_t const block_height = pal_get_format_block_height(wrapped_asset_sampled_image_format);
    ...
    else
    {
        ...
        asset_sampled_image->WriteToSubresource(dst_mip_level, NULL, reinterpret_cast<void *>(reinterpret_cast<uintptr_t>(staging_buffer_memory_range_base) + src_offset), src_row_pitch, src_row_pitch * src_row_count);

        asset_sampled_image->Unmap(0U, NULL);
    }
}

void pal_d3d12_upload_command_buffer::build_staging_non_compacted_bottom_level_acceleration_structure(pal_scratch_buffer *wrapped_scratch_buffer, uint32_t scratch_buffer_offset, pal_staging_non_compacted_bottom_level_acceleration_structure *wrapped_staging_non_compacted_bottom_level_acceleration_structure, uint32_t bottom_level_acceleration_structure_geometry_count, PAL_BOTTOM_LEVEL_ACCELERATION_STRUCTURE_GEOMETRY const *wrapped_bottom_level_acceleration_structure_geometries, pal_compacted_bottom_level_acceleration_structure_size_query_pool *wrapped_compacted_bottom_level_acceleration_structure_size_query_pool, uint32_t query_index)
{
    assert(NULL != wrapped_staging_non_compacted_bottom_level_acceleration_structure);
    D3D12_GPU_VIRTUAL_ADDRESS const destination_acceleration_structure_device_memory_range_base = static_cast<pal_d3d12_staging_non_compacted_bottom_level_acceleration_structure *>(wrapped_staging_non_compacted_bottom_level_acceleration_structure)->get_device_memory_range_base();

    assert(NULL != wrapped_bottom_level_acceleration_structure_geometries);
    pal_vector<D3D12_RESOURCE_BARRIER> vertex_position_buffer_load_barriers;
    pal_vector<D3D12_RESOURCE_BARRIER> vertex_position_buffer_store_barriers;
    pal_vector<D3D12_RESOURCE_BARRIER> index_buffer_load_barriers;
    pal_vector<D3D12_RESOURCE_BARRIER> index_buffer_store_barriers;
    ...
    for (uint32_t bottom_level_acceleration_structure_geometry_index = 0U; bottom_level_acceleration_structure_geometry_index < bottom_level_acceleration_structure_geometry_count; ++bottom_level_acceleration_structure_geometry_index)
    {
        ...
        ID3D12Resource *const unwrapped_vertex_position_buffer_resource = static_cast<pal_d3d12_asset_vertex_position_buffer *>(wrapped_bottom_level_acceleration_structure_geometry.vertex_position_buffer)->get_resource();
        ...
        ID3D12Resource *const unwrapped_index_buffer_resource = (PAL_GRAPHICS_PIPELINE_INDEX_TYPE_NONE != wrapped_bottom_level_acceleration_structure_geometry.index_type) ? static_cast<pal_d3d12_asset_index_buffer *>(wrapped_bottom_level_acceleration_structure_geometry.index_buffer)->get_resource() : NULL;

        if (PAL_GRAPHICS_PIPELINE_INDEX_TYPE_NONE != wrapped_bottom_level_acceleration_structure_geometry.index_type)
        {
        ...
        D3D12_GPU_VIRTUAL_ADDRESS const index_buffer_device_memory_range_base = (PAL_GRAPHICS_PIPELINE_INDEX_TYPE_NONE != wrapped_bottom_level_acceleration_structure_geometry.index_type) ? unwrapped_index_buffer_resource->GetGPUVirtualAddress() : NULL;
    ...
    D3D12_GPU_VIRTUAL_ADDRESS const query_pool_device_memory_range_base = static_cast<pal_d3d12_compacted_bottom_level_acceleration_structure_size_query_pool *>(wrapped_compacted_bottom_level_acceleration_structure_size_query_pool)->get_resource()->GetGPUVirtualAddress();
...
void pal_d3d12_upload_command_buffer::compact_bottom_level_acceleration_structure(pal_asset_compacted_bottom_level_acceleration_structure *wrapped_destination_asset_compacted_bottom_level_acceleration_structure, pal_staging_non_compacted_bottom_level_acceleration_structure *wrapped_source_staging_non_compacted_bottom_level_acceleration_structure)
{
    ...
    ID3D12Resource *const destination_acceleration_structure_buffer_resource = static_cast<pal_d3d12_asset_compacted_bottom_level_acceleration_structure *>(wrapped_destination_asset_compacted_bottom_level_acceleration_structure)->get_resource();
    D3D12_GPU_VIRTUAL_ADDRESS const destination_acceleration_structure_device_memory_range_base = destination_acceleration_structure_buffer_resource->GetGPUVirtualAddress();
    D3D12_GPU_VIRTUAL_ADDRESS const source_acceleration_structure_device_memory_range_base = static_cast<pal_d3d12_staging_non_compacted_bottom_level_acceleration_structure *>(wrapped_source_staging_non_compacted_bottom_level_acceleration_structure)->get_device_memory_range_base();
...
void pal_d3d12_upload_command_buffer::release_asset_vertex_position_buffer(pal_asset_vertex_position_buffer *asset_vertex_position_buffer)
{
    // do nothing
}

void pal_d3d12_upload_command_buffer::release_asset_vertex_varying_buffer(pal_asset_vertex_varying_buffer *asset_vertex_varying_buffer)
{
    // do nothing
}

void pal_d3d12_upload_command_buffer::release_asset_index_buffer(pal_asset_index_buffer *asset_index_buffer)
{
    // do nothing
}

void pal_d3d12_upload_command_buffer::release_asset_sampled_image(pal_asset_sampled_image *asset_sampled_image, uint32_t dst_mip_level)
{
    // do nothing
}

void pal_d3d12_upload_command_buffer::release_asset_compacted_bottom_level_acceleration_structure(pal_asset_compacted_bottom_level_acceleration_structure *asset_compacted_bottom_level_acceleration_structure)
{
    // do nothing
}

void pal_d3d12_upload_command_buffer::end()
{
    if ((!this->m_uma) || this->m_support_ray_tracing)
    {
