...
bool pal_d3d12_device::is_asset_sampled_image_compression_bc_supported() const
{
	return true;
}

bool pal_d3d12_device::is_asset_sampled_image_compression_astc_supported() const
{
	return false;
}
